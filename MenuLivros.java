...
public class MenuLivros {
  ...
  public void menu() {
    ...
    do {
      ...
      System.out.println("\n> Início > Livros");
      System.out.println("\n1) Inclui livro");
      System.out.println("2) Busca livro ISBN");
      System.out.println("3) Altera livro");
      System.out.println("4) Exclui livro");
      System.out.println("5) Busca livro titulo");
  ...
  public void buscarLivroTitulo() {
    ...
    System.out.println("\n> Início > Livros > Busca");
    System.out.print("\nTitulo: ");
    titulo = console.nextLine(); // lê a string do usuário
    if (titulo.length() == 0) // se n tiver nada return
      return;
    ...
    try { 
      ...
      imprimeLivros(lista); // se encontrar um livro imprime a lista de livros encontrados
    } catch (Exception e) {
      System.out.println("Erro no acesso ao arquivo");
      e.printStackTrace();
    }
